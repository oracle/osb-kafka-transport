...
import com.bea.wli.sb.transports.DefaultResponseHeaders;
 ...
 */
public class KafkaResponseHeaders extends
		DefaultResponseHeaders<KafkaResponseHeadersXML> {

	public KafkaResponseHeaders(ResponseHeadersXML headers)
			throws TransportException {

		super(KafkaTransportProvider.getInstance(), headers);

	}
	
	public void setTopicName(String topicName) {
		
		setHeader("topic-name", topicName);
	...
	private static final long serialVersionUID = 2961627464065220196L;
