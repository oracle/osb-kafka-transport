 ...
 */
public class KafkaRequestHeaders extends
		DefaultRequestHeaders<KafkaRequestHeadersXML> {

	public KafkaRequestHeaders(RequestHeadersXML headers)
	...
	public Integer getPartition() {
		...
		BigInteger value = (BigInteger) getHeader("partition");
	...
	public String getMessageKey() {
		...
		return (String) getHeader("message-key");

	}

	public void setMessageKey(String messageKey) {

		setHeader("message-key", messageKey);
