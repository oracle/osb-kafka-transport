...
import com.bea.wli.sb.transports.ResponseHeadersXML;
 ...
 */
public class KafkaResponseMetadata extends
		DefaultResponseMetaData<KafkaResponseMetaDataXML> {

	public KafkaResponseMetadata() throws TransportException {

		super(KafkaTransportProvider.getInstance());

	}

	@Override
	protected ResponseHeaders createHeaders(TransportProvider provider,
			ResponseHeadersXML headersXML) throws TransportException {

		return new KafkaResponseHeaders(headersXML);

	}

	private static final long serialVersionUID = -1321185702686299442L;
