 ...
 */
public class KafkaRequestMetadata extends
		DefaultRequestMetaData<KafkaRequestMetaDataXML> {

	public KafkaRequestMetadata() throws TransportException {
	...
	protected RequestHeaders createHeaders(TransportProvider provider,
			RequestHeadersXML headers) throws TransportException {

		return new KafkaRequestHeaders(headers);
