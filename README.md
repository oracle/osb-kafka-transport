...
## Introduction
This project provides a native transport provider for OSB (Oracle Service Bus) to allow connectivity with Apache Kafka. By using this transport, integration developers can leverage the transformation/routing capabilities from OSB to implement use cases that requires sending and/or receiving messages to/from Apache Kafka.
